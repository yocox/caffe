...
def convert_to_db():
    ...
    os.system('../../build/tools/convert_imageset.bin ./ train_file_label.txt multi-label-train.leveldb')
    os.system('../../build/tools/convert_imageset.bin ./ test_file_label.txt multi-label-test.leveldb')

def compute_mean():
    os.system('../../build/tools/compute_image_mean.bin multi-label-train.leveldb mean.binaryproto')
